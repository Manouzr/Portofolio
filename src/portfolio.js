...
const skillsSection = {
  title: "Je fais quoi ?",
  subTitle: "JE SUIS UN DEVELOPPEUR AMATEUR PASSIONNÉ D'INFORMATIQUE",
  skills: [
    emoji(
...
const achievementSection = {
  title: emoji("Succès et Certifications 🏆 "),
  subtitle:
    "Les succès, Certifications,Lettres de Récompenses et d'autres truc cool que j'ai eu !",
...
const podcastSection = {
  ...
  podcast: [
    "https://open.spotify.com/embed/artist/3xxJpgte8ObLtWWaUfWZ3W?utm_source=oembed"
  ],
  display: true // Set false to hide this section, defaults to true
};
